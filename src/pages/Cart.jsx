...
export const Cart = () => {
    ...
    const pizzasGroup = Object.keys(items).map(key => items[key].items[0])
            ...
            {totalCount ?
                <div className="cart">
                    ...
                    <div className="content__items">
                        ...
                        {pizzasGroup.map(obj => <CartItem id={obj.id}
                                                          name={obj.name}
                                                          type={obj.type}
                                                          size={obj.size}
                                                          totalPricePizzaGroup={items[obj.id].totalPrice}
                    ...
                    <div className="cart__bottom">
                        ...
                        <div className="cart__bottom-buttons">
                            ...
                            <Button onClick={onPayOrder} className="button pay-btn">
